...
- (void)testCanInitFLTIamportWebViewController {
  FLTIamportWebViewController *controller =
      [[FLTIamportWebViewController alloc] initWithFrame:CGRectMake(0, 0, 300, 400)
                                   viewIdentifier:1
                                        arguments:nil
...
- (void)testCanInitFLTIamportWebViewFactory {
  FLTIamportWebViewFactory *factory =
      [[FLTIamportWebViewFactory alloc] initWithMessenger:self.mockBinaryMessenger];
...
- (void)testContentInsetsSumAlwaysZeroAfterSetFrame {
  FLTIamportWKWebView *webView = [[FLTIamportWKWebView alloc] initWithFrame:CGRectMake(0, 0, 300, 400)];
